...
import { UserPlus, Loader, Lock, Mail, User, ArrowRight } from 'lucide-react'
...
export const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col  justify-center py-12 sm:px-6 lg:px-8'>
            ...
            bg-clip-text text-transparent'>Start building your fundraising legacy today</h2>
			...
			<motion.div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'
				...
				<div className='bg-gradient-to-r from-violet-400 to-blue-400 py-8 px-4 shadow sm:rounded-lg sm:px-10 '>
                  ...
                  '/>
						...
						<h2 className='text-3xl text-white font-bold text-center'>Join Our Elite Community</h2>
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-gray-200 border border-gray-600 rounded-md shadow-sm
					...
					<p className='mt-8 text-center text-sm text-white'>
						...
						<Link to='/login' className='font-medium text-black hover:text-violet-800'>
